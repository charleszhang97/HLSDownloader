...
namespace FlyVR.Aria2
{
    ...
    public interface Aria2cProxy : IXmlRpcProxy
    {
        ...
        string AddUri(string secret, string[] uris);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.addUri
        [XmlRpcMethod("aria2.addUri")]
        string AddUri(string secret, string[] uris, XmlRpcStruct options);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.addUri
        [XmlRpcMethod("aria2.addUri")]
        string AddUri(string secret, string[] uris, XmlRpcStruct options, int position);
        ...
        string AddTorrent(string secret, byte[] torrent);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.addUri
        [XmlRpcMethod("aria2.addTorrent")]
        string AddTorrent(string secret, byte[] torrent, string[] uris);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.addUri
        [XmlRpcMethod("aria2.addTorrent")]
        string AddTorrent(string secret, byte[] torrent, string[] uris, XmlRpcStruct options);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.addUri
        [XmlRpcMethod("aria2.addTorrent")]
        string AddTorrent(string secret, byte[] torrent, string[] uris, XmlRpcStruct options, int position);
        ...
        string Remove(string secret, string gid);
        ...
        string ForceRemove(string secret, string gid);
        ...
        string Pause(string secret, string gid);
        ...
        string ForcePause(string secret, string gid);
        ...
        string ForcePauseAll(string secret);
        ...
        string UnPause(string secret, string gid);
        ...
        string UnPauseAll(string secret);
        ...
        XmlRpcStruct[] GetUris(string secret, string gid);
        ...
        XmlRpcStruct[] GetFiles(string secret, string gid);
        ...
        XmlRpcStruct[] GetPeers(string secret, string gid);
        ...
        XmlRpcStruct[] GetServers(string secret, string gid);
        ...
        int ChangePosition(string secret, string gid, int pos, string how);
        ...
        int[] ChangeUri(string secret, string gid, int fileIndex, string[] delUris, string[] addUris);
        ...
        /// 详情参考 http://aria2.github.io/manual/en/html/aria2c.html#aria2.changeUri
        [XmlRpcMethod("aria2.changeUri")]
        int[] ChangeUri(string secret, string gid, int fileIndex, string[] delUris, string[] addUris, int position);
        ...
        XmlRpcStruct GetOption(string secret, string gid);
        ...
        string ChangeOption(string secret, string gid, XmlRpcStruct options);
        ...
        XmlRpcStruct GetGlobalOption(string secret);
        ...
        string ChangeGlobalOption(string secret, XmlRpcStruct options);
        ...
        XmlRpcStruct GetGlobalStat(string secret);
        ...
        string PurgeDownloadResult(string secret);
        ...
        string RemoveDownloadResult(string secret, string gid);
        ...
        XmlRpcStruct GetVersion(string secret);
        ...
        XmlRpcStruct GetSessionInfo(string secret);
        ...
        string ForceShutdown(string secret);
        ...
        string SaveSession(string secret);
    }
}
